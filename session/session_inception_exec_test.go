...
func (s *testSessionIncSuite) TestCreateTable(c *C) {
	...
	// 表存在
	res := makeSql(tk, "drop table if exists t1;create table t1(id int);create table t1(id int);")
	...
	res = makeSql(tk, "drop table t1;create table t1(id int);")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	...
	// 数据类型 警告
	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 bit);")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "1")
	c.Assert(row[4], Equals, "Not supported data type on field: 'c1'.")

	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 enum('red', 'blue', 'black'));")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "1")
	c.Assert(row[4], Equals, "Not supported data type on field: 'c1'.")

	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 set('red', 'blue', 'black'));")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "1")
	c.Assert(row[4], Equals, "Not supported data type on field: 'c1'.")
	...
	res = makeSql(tk, `drop table if exists t1;create table t1(id int,c1 char(200));`)
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "1")
	c.Assert(row[4], Equals, "Set column 'c1' to VARCHAR type.")

	// 字符集
	res = makeSql(tk, `drop table if exists t1;create table t1(id int,c1 varchar(20) character set utf8,
	...
	res = makeSql(tk, `drop table if exists t1;create table t1(id int,c1 varchar(20)) COLLATE utf8_bin;`)
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "1")
	c.Assert(row[4], Equals, "表 't1' 禁止设置字符集!")
	...
	res = makeSql(tk, "drop table if exists t1;create table t1(id int, TABLES varchar(20),`c1$` varchar(20),c1234567890123456789012345678901234567890123456789012345678901234567890 varchar(20));")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "2")
	...
	res = makeSql(tk, "drop table if exists t1;create table t1(c1 varchar(20));")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "1")
	...
	// 无效默认值
	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 int default '');")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "2")
	...
	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 blob, c2 text);")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "2")
	...
	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 blob not null);")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "1")
	...
	res = makeSql(tk, "drop table if exists t1;create table t1(c1 varchar(10));")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "1")
	...
	res = makeSql(tk, "drop table if exists t1;create table t1(c1 varchar(10))engine = myisam;")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "2")
...
func (s *testSessionIncSuite) TestDropTable(c *C) {
	...
	res := makeSql(tk, "drop table if exists t1;create table t1(id int);drop table t1;")
	row := res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "2")
...
func (s *testSessionIncSuite) TestAlterTableAddColumn(c *C) {
	...
	// 检查默认值
	config.GetGlobalConfig().Inc.CheckColumnDefaultValue = true
	res = makeSql(tk, "drop table if exists t1;create table t1(id int);alter table t1 add column c1 varchar(10);")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "1")
	c.Assert(row[4], Equals, "Set Default value for column 'c1' in table 't1'")
	config.GetGlobalConfig().Inc.CheckColumnDefaultValue = false
...
func (s *testSessionIncSuite) TestAlterTableAlterColumn(c *C) {
	...
	res := makeSql(tk, "drop table if exists t1;create table t1(id int);alter table t1 alter column id set default '';")
	row := res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "2")
	c.Assert(row[4], Equals, "Invalid default value for column 'id'.")

	res = makeSql(tk, "drop table if exists t1;create table t1(id int);alter table t1 alter column id set default '1';")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "0")

	res = makeSql(tk, "drop table if exists t1;create table t1(id int);alter table t1 alter column id drop default ;alter table t1 alter column id set default '1';")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "0")
	row = res.Rows()[3]
	c.Assert(row[2], Equals, "0")
...
func (s *testSessionIncSuite) TestAlterTableModifyColumn(c *C) {
	...
	res := makeSql(tk, "drop table if exists t1;create table t1(id int,c1 int);alter table t1 modify column c1 int first;")
	for _, row := range res.Rows() {
		c.Assert(row[2], Not(Equals), "2")
	}

	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 int);alter table t1 modify column id int after c1;")
	for _, row := range res.Rows() {
		c.Assert(row[2], Not(Equals), "2")
	}

	// after 不存在的列
	res = makeSql(tk, "drop table if exists t1;create table t1(id int);alter table t1 modify column c1 int after id;")
	row := res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "2")
	c.Assert(row[4], Equals, "Column 't1.c1' not existed.")

	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 int);alter table t1 modify column c1 int after id1;")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "2")
	c.Assert(row[4], Equals, "Column 't1.id1' not existed.")

	// 数据类型 警告
	res = makeSql(tk, "drop table if exists t1;create table t1(id bit);alter table t1 modify column id bit;")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "1")
	c.Assert(row[4], Equals, "Not supported data type on field: 'id'.")

	res = makeSql(tk, "drop table if exists t1;create table t1(id enum('red', 'blue'));alter table t1 modify column id enum('red', 'blue', 'black');")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "1")
	c.Assert(row[4], Equals, "Not supported data type on field: 'id'.")

	res = makeSql(tk, "drop table if exists t1;create table t1(id set('red'));alter table t1 modify column id set('red', 'blue', 'black');")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "1")
	c.Assert(row[4], Equals, "Not supported data type on field: 'id'.")
	...
	// char列建议
	config.GetGlobalConfig().Inc.MaxCharLength = 100
	res = makeSql(tk, `drop table if exists t1;create table t1(id int,c1 char(10));
	...
	// 字符集
	res = makeSql(tk, `drop table if exists t1;create table t1(id int,c1 varchar(20));
	...
	// 列注释
	config.GetGlobalConfig().Inc.CheckColumnComment = true
	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 varchar(10));alter table t1 modify column c1 varchar(20);")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "1")
	c.Assert(row[4], Equals, "Column 'c1' in table 't1' have no comments.")
	...
	// 无效默认值
	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 int);alter table t1 modify column c1 int default '';")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "2")
	c.Assert(row[4], Equals, "Invalid default value for column 'c1'.")
	...
	// blob/text字段
	config.GetGlobalConfig().Inc.EnableBlobType = false
	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 varchar(10));alter table t1 modify column c1 blob;alter table t1 modify column c1 text;")
	row = res.Rows()[int(tk.Se.AffectedRows())-2]
	c.Assert(row[2], Equals, "2")
	c.Assert(row[4], Equals, "Type blob/text is used in column 'c1'.")
	...
	config.GetGlobalConfig().Inc.EnableBlobType = true
	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 blob);alter table t1 modify column c1 blob not null;")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "1")
	c.Assert(row[4], Equals, "TEXT/BLOB Column 'c1' in table 't1' can't  been not null.")
	...
	// 检查默认值
	config.GetGlobalConfig().Inc.CheckColumnDefaultValue = true
	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 varchar(5));alter table t1 modify column c1 varchar(10);")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "1")
	c.Assert(row[4], Equals, "Set Default value for column 'c1' in table 't1'")
	config.GetGlobalConfig().Inc.CheckColumnDefaultValue = false
	...
	// 变更类型
	res = makeSql(tk, "drop table if exists t1;create table t1(c1 int,c1 int);alter table t1 modify column c1 varchar(10);")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "1")
	c.Assert(row[4], Equals, "类型转换警告: 列 't1.c1' int(11) -> varchar(10).")

	res = makeSql(tk, "drop table if exists t1;create table t1(c1 char(100));alter table t1 modify column c1 char(20);")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "0")

	res = makeSql(tk, "drop table if exists t1;create table t1(c1 varchar(100));alter table t1 modify column c1 varchar(10);")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "0")
...
func (s *testSessionIncSuite) TestAlterTableDropColumn(c *C) {
	...
	res := makeSql(tk, "drop table if exists t1;create table t1(id int,c1 int);alter table t1 drop column c2;")
	row := res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "2")
	c.Assert(row[4], Equals, "Column 't1.c2' not existed.")

	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 int);alter table t1 drop column c1;")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "0")
...
func (s *testSessionIncSuite) TestInsert(c *C) {
	...
	// 列数不匹配
	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 int);insert into t1(id) values(1,1);")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "2")
	c.Assert(row[4], Equals, "Column count doesn't match value count at row 1.")

	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 int);insert into t1(id) values(1),(2,1);")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "2")
	c.Assert(row[4], Equals, "Column count doesn't match value count at row 2.")

	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 int not null);insert into t1(id,c1) select 1;")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "2")
	c.Assert(row[4], Equals, "Column count doesn't match value count at row 1.")

	// 列重复
	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 int);insert into t1(id,id) values(1,1);")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "2")
	c.Assert(row[4], Equals, "Column 'id' specified twice in table 't1'.")

	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 int);insert into t1(id,id) select 1,1;")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "2")
	c.Assert(row[4], Equals, "Column 'id' specified twice in table 't1'.")
	...
	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 int);insert into t1 values(1,1);")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "1")
	c.Assert(row[4], Equals, "insert语句需要指定字段列表.")
	config.GetGlobalConfig().Inc.CheckInsertField = false

	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 int);insert into t1(id) values();")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "2")
	c.Assert(row[4], Equals, "insert语句需要指定值列表.")

	// 列不允许为空
	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 int not null);insert into t1(id,c1) values(1,null);")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "2")
	c.Assert(row[4], Equals, "Column 'test_inc.t1.c1' cannot be null in 1 row.")

	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 int not null default 1);insert into t1(id,c1) values(1,null);")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "2")
	c.Assert(row[4], Equals, "Column 'test_inc.t1.c1' cannot be null in 1 row.")

	// insert select 表不存在
	res = makeSql(tk, "drop table if exists t1;drop table if exists t2;create table t1(id int,c1 int );insert into t1(id,c1) select 1,null from t2;")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "2")
	...
	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 int );insert into t1(id,c1) select 1,null from t1;")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "1")
	...
	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 int );insert into t1(id,c1) select 1,null from t1 limit 1;")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "1")
	...
	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 int );insert into t1(id,c1) select 1,null from t1 order by rand();")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "1")
	...
	// 受影响行数
	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 int);insert into t1 values(1,1),(2,2);")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "0")
	c.Assert(row[6], Equals, "2")

	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 int );insert into t1(id,c1) select 1,null;")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "0")
...
func (s *testSessionIncSuite) TestUpdate(c *C) {
	...
	res := makeSql(tk, `drop table if exists t1;drop table if exists t2;create table t1(id int primary key,c1 int);
	...
	// where
	config.GetGlobalConfig().Inc.CheckDMLWhere = true
	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 int);update t1 set c1 = 1;")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "1")
	c.Assert(row[4], Equals, "selete语句请指定where条件.")
	config.GetGlobalConfig().Inc.CheckDMLWhere = false
	...
	// limit
	config.GetGlobalConfig().Inc.CheckDMLLimit = true
	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 int);update t1 set c1 = 1 limit 1;")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "1")
	c.Assert(row[4], Equals, "Limit is not allowed in update/delete statement.")
	config.GetGlobalConfig().Inc.CheckDMLLimit = false
	...
	// order by rand()
	config.GetGlobalConfig().Inc.CheckDMLOrderBy = true
	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 int);update t1 set c1 = 1 order by rand();")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "1")
...
func (s *testSessionIncSuite) TestDelete(c *C) {
	...
	// res = makeSql(tk, "drop table if exists t1;create table t1(id int);delete from t1 where c1 = 1;")
	// row = res.Rows()[int(tk.Se.AffectedRows())-1]
	// c.Assert(row[2], Equals, "2")
	// c.Assert(row[4], Equals, "Column 'c1' not existed.")

	// res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 int);delete from t1 where c1 = 1 and c2 = 1;")
	// row = res.Rows()[int(tk.Se.AffectedRows())-1]
	// c.Assert(row[2], Equals, "2")
	// c.Assert(row[4], Equals, "Column 't1.c2' not existed.")
	...
	// where
	config.GetGlobalConfig().Inc.CheckDMLWhere = true
	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 int);delete from t1;")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "1")
	c.Assert(row[4], Equals, "selete语句请指定where条件.")
	config.GetGlobalConfig().Inc.CheckDMLWhere = false
	...
	// limit
	config.GetGlobalConfig().Inc.CheckDMLLimit = true
	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 int);delete from t1 where id = 1 limit 1;")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "1")
	c.Assert(row[4], Equals, "Limit is not allowed in update/delete statement.")
	config.GetGlobalConfig().Inc.CheckDMLLimit = false
	...
	// order by rand()
	config.GetGlobalConfig().Inc.CheckDMLOrderBy = true
	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 int);delete from t1 where id = 1 order by rand();")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "1")
	c.Assert(row[4], Equals, "Order by is not allowed in update/delete statement.")
	config.GetGlobalConfig().Inc.CheckDMLOrderBy = false
	...
	// 受影响行数
	res = makeSql(tk, "drop table if exists t1;create table t1(id int,c1 int);delete from t1 where id = 1;")
	row = res.Rows()[int(tk.Se.AffectedRows())-1]
	c.Assert(row[2], Equals, "0")
	c.Assert(row[6], Equals, "0")
}
