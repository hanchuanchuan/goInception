...
var (
	MyErrors = [...]string{
		...
		"Limit is not allowed in update/delete statement.",
		"Order by is not allowed in update/delete statement.",
		...
		"The binlog_format is statement, backup is disabled.",
		"Not allow set argument.",
		"Require argument.",
		"Ambiguous argument.",
		...
		"Identifier '%s' is keyword in MySQL.",
		"View's SELECT contains a '%s' clause",
		"Can not find OSC executing task",
		"Got packets out of order",
		"Not supported expression type '%s'.",
		"Identifier '%s' is invalid, valid options: [a-z|A-Z|0-9|_].",
		"Inception error, Query was empty.",
